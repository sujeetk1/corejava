...
/*
 * Get the product name whose price is less than 14000
 */
 ...
 *
 */
public class FilterProductNameFromCollection {
	...
	public static void main(String[] args) {
		...
		List<String> nameOfFilteredProduct = listOfProduct.stream()
												.filter(x -> x.getPrice() < 14000)
												.map(p -> p.getProductName())
												.collect(Collectors.toList());
		
		nameOfFilteredProduct.forEach(System.out::println);
